...
//   // Get the content type (movie or TV show) from the global store
//   const { contentType } = useContentStore();
//   console.log( "Content Type" ,contentType)

//   // Fetch the trailers for the content
//   useEffect(() => {
...
//   // Fetch: similar content (e.g., similar movies or TV shows)
//   useEffect(() => {
//     const getSimilarContent = async () => {
//       try {
//         const res = await axios.get(`/api/v1/${contentType}/${id}/similar`);
//         console.log("Similar Content:" , res.data)
//         setSimilarContent(res.data.similarMovies || []);
//       } catch (error) {
//         console.error("Error fetching similar content:", error);
//         setSimilarContent([]); // Set to an empty array if an error occurs
//       }
//     };
...
//   // Fetch the details of the content
//   useEffect(() => {
//     const getContentDetails = async () => {
//       setLoading(true); // Set loading to true before the request
//       try {
//         const res = await axios.get(`/api/v1/${contentType}/${id}/details`);
//         console.log("Content details :", res.data)
//         setContent(res.data.content);
//       } catch (error) {
//         console.error("Error fetching content details:", error);
//         setContent({}); // Set to an empty object if an error occurs
//       } finally {
...
import ReactPlayer from "react-player";
import { ORIGINAL_IMG_BASE_URL, SMALL_IMG_BASE_URL } from "../utils/constants";
import { formatReleaseDate } from "../utils/data.Function";
import WatchPageSkeleton from "../components/skeletons/WatchPageSkeleton";
...
const WatchPage = () => {
  ...
  useEffect(() => {
    const getContentDetails = async () => {
      try {
        const res = await axios.get(`/api/v1/${contentType}/${id}/details`);
        setContent(res.data.content || res.data.movie);
      } catch (error) {
        if (error.message.includes("404")) {
          setContent(null);
        }
